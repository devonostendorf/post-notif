...
?>
	<div class="wrap">
      <h2><?php echo esc_html( get_admin_page_title() ); ?></h2>           
        ...
        <form action="<?php echo esc_attr( get_admin_url() ); ?>admin-post.php" method="post" enctype="multipart/form-data">
            	...
            	<tr valign="top">
            		<th scope="row">
							<label for="btnSubscriberFile"><?php _e( 'Import from file:', 'post-notif' ); ?></label>
						</th>
            		<td>
					...
					<tr valign="top">
						<th scope="row">
							<label for="tarSubscriberData"><?php _e( 'Import directly:', 'post-notif' ); ?></label>
						</th>
						<td>
