...
<?php elseif ( $subscribers_deleted ) : ?>
		<div class="updated fade">
			<p>
				<strong><?php echo sprintf( _n( 'Subscriber deleted.', '%s subscribers deleted.', $subscribers_deleted, 'post-notif' ), number_format_i18n( $subscribers_deleted ) ) ?>&nbsp;<a href="<?php echo esc_url( $undo_delete_url ); ?>"><?php esc_html_e( 'Undo', 'post-notif' ); ?></a></strong>
			</p>
		</div>
<?php elseif ( $subscribers_undeleted ) : ?>
		<div class="updated fade">
			<p>
				<strong><?php echo sprintf( _n( 'Deletion of subscriber has been undone.', 'Deletion of %s subscribers has been undone.', $subscribers_undeleted, 'post-notif' ), number_format_i18n( $subscribers_undeleted ) ) ?></strong>
			</p>
		</div>
